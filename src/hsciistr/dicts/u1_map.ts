...
// change yet (still Devanagari values for every script). u1_map.ts is
// for Devanagari (hindi/marathi, block U+0900-U+097F) and its
// entries need verifying/rewriting against Devanagari's own Unicode chart

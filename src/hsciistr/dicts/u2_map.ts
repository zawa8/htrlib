...
// change yet (still Devanagari values for every script). u2_map.ts is
// for Bengali (bengali, block U+0980-U+09FF) and its
// entries need verifying/rewriting against Bengali's own Unicode chart

...
// change yet (still Devanagari values for every script). u6_map.ts is
// for Tamil (tamil, block U+0B80-U+0BFF) and its
// entries need verifying/rewriting against Tamil's own Unicode chart

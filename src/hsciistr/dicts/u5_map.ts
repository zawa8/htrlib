...
// change yet (still Devanagari values for every script). u5_map.ts is
// for Oriya (odia, block U+0B00-U+0B7F) and its
// entries need verifying/rewriting against Oriya's own Unicode chart

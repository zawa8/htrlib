export const U10_MAP = {
  ...
  unicode_hindi_array: [
    ...
    'T', // ठ da8 = sinhala letter ttha
    'd', // ड da9 = sinhala letter dda
    'D', // ढ daa = sinhala letter ddha
    'n', // ण dab = sinhala letter nna
    'n', //   dac = sinhala letter nndda
    'j', // त dad = sinhala letter тa
    'J', // थ dae = sinhala letter тha
    'q', // द daf = sinhala letter ԃa
    'Q', // ध db0 = sinhala letter ԃha

...
// change yet (still Devanagari values for every script). u8_map.ts is
// for Kannada (kannada, block U+0C80-U+0CFF) and its
// entries need verifying/rewriting against Kannada's own Unicode chart

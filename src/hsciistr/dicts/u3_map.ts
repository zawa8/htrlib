...
// change yet (still Devanagari values for every script). u3_map.ts is
// for Gurmukhi (punjabi, block U+0A00-U+0A7F) and its
// entries need verifying/rewriting against Gurmukhi's own Unicode chart
